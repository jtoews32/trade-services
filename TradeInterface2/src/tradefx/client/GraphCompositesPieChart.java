...
import tradefx.client.GraphComposites.AreaChartExample;
...
public class GraphCompositesPieChart extends LayoutContainer {  
	...
	protected void onRender(Element parent, int index) {  
		...
		// String url = "gxt/resources/chart/open-flash-chart.swf";  
